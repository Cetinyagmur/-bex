"""
MIR Coin Telegram Topluluk Botu
--------------------------------
Özellikler:
...
TOKEN_NAME = os.environ.get("TOKEN_NAME", "MIR")
...
async def price_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        f"💰 <b>{TOKEN_NAME} Fiyat Bilgisi</b>\n\n"
        f"Fiyat: ${price_usd}\n"
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        f"Merhaba! Ben {TOKEN_NAME} topluluk botuyum.\n\n"
        "Komutlar:\n"
...
if __name__ == "__main__":
    ...
    logger.info("MIR bot başlatılıyor...")
